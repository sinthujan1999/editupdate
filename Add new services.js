...
<div>
        <Grid container>
            <Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Companyname">Companyname-{this.state.Companyname}</Typography>
 </div>
  <Button id="CompanynameEdit" onClick={this.editCompanyname}>Edit</Button>
...
<Button onClick={this.editCompanynameCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editCompanynameUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                  ...
                  <div>
<Typography variant="h6" id="Workdistance">Workdistance-{this.state.Workdistance}KM</Typography>
 </div>
  <Button id="WorkdistanceEdit" onClick={this.editWorkdistance}>Edit</Button>
...
<Button onClick={this.editWorkdistanceCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editWorkdistanceUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                  ...
                  <div>
<Typography variant="h6" id="Service">Service-{this.state.Service}</Typography>
 </div>
  <Button id="ServiceEdit" onClick={this.editService}>Edit</Button>
                      
    {this.state.Serviceedit &&(
  
                          <Dialog
                          open={this.editService}
                          onClose={this.handleClickClose}
                        
                        >
                        <DialogTitle >{"Edit Your Service"}</DialogTitle>
                  <DialogContent>

                            {this.state.Serviceedit &&(
                              <card>
                              <FormControl variant="outlined" >
                              <TextField id="Service" select label="Service" value={this.state.onChangeUpdateService } onChange={this.onChangeUpdateService } helperText="Please select your Service" > 
...
<Button onClick={this.editServiceCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editServiceUpdate} color="primary" autoFocus>
                              Update
                            </Button>
...
<div>
<Typography variant="h6" id="Phone">Phone Number-{this.state.Phone}</Typography>
</div>
<Button id="PhoneEdit" onClick={this.editPhone}>Edit</Button>
...
<Button onClick={this.editPhoneCancel} color="primary">
            Cancel
          </Button>
          <Button  onClick={this.editPhoneUpdate} color="primary" autoFocus>
            Update
          </Button>
...
<Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Address">Opentime-{this.state.Opentime}</Typography>
 </div>
  <Button id="OpentimeEdit" onClick={this.editOpentime}>Edit</Button>
...
<Button onClick={this.editOpentimeCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editOpentimeUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                  ...
                  <Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Address">Finishtime-{this.state.Finishtime}</Typography>
 </div>
  <Button id="FinishtimeEdit" onClick={this.editFinishtime}>Edit</Button>
...
<Button onClick={this.editFinishtimeCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editFinishtimeUpdate} color="primary" autoFocus>
                              Update
                            </Button>
...
<Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Price">Price-Rs.{this.state.Price}</Typography>
 </div>
  <Button id="PriceEdit" onClick={this.editPrice}>Edit</Button>
...
<Button onClick={this.editPriceCancel } color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editPriceUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                  ...
                  <Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Address">Addressname-{this.state.Address}</Typography>
 </div>
  <Button id="AddressEdit" onClick={this.editAddress}>Edit</Button>
...
<Button onClick={this.editAddressCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editAddressUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                  ...
                  <Grid item xs={4}>
                  <div>
<Typography variant="h6" id="Description">Description-<textarea  onChange={this.onChangeUpdateDescription}  value={this.state.updateDescription}/></Typography>
 </div>
  <Button id="DescriptionEdit" onClick={this.editDescription}>Edit</Button>
...
<Button onClick={this.editDescriptionCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editDescriptionUpdate} color="primary" autoFocus>
                              Update
                            </Button>
...
<div>
<Typography variant="h6" id="Vehicle">Vehicle-{this.state.Vehicle}</Typography>
</div>
<Button id="VehicleEdit" onClick={this.editVehicle}>Edit</Button>
...
<Button onClick={this.editVehicleCancel} color="primary">
            Cancel
          </Button>
          <Button  onClick={this.editVehicleUpdate} color="primary" autoFocus>
            Update
          </Button>
...
<Grid item xs={4}>
                  <div>
<Typography variant="h6" id="file"><Avatar style={{ width: "150px" ,height:"150px"}} src={this.state.fileo} /></Typography>
 </div>
  <Button id="CompanynameEdit" onClick={this.editfile}>Edit</Button>
    ...
    {this.state.fileedit &&(
                        ...
                        >
                        <DialogTitle > <AddAPhotoIcon/>{" Upload your Photo"}</DialogTitle>
                  <DialogContent>
                            ...
                            {this.state.fileedit &&(
                              ...
                              <FormControl variant="outlined" >
                                  ...
                                  <Input
                                      id="Companyname"
                                      value={this.state.editfile}
                                      onChange={this.onChangeUpdatefile}
                                      label="uploadfile"
                                      type="file" accept="image/*"id="uploadfile"
...
<Button onClick={this.editfileCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editfileUpdate} color="primary" autoFocus>
                           Update
                            </Button>
...
//       { latitude:9.7999968, longitude:  80.1999992 },
